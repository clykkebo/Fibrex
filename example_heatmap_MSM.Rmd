...
# Run Spearman test
corrmat <- cor(x = dat.SCFA[,1:3], y = dat.SCFA[4:7], method = "spearman", use = "pairwise.complete.obs")

# Create heatmap
corrmat_rounded <- round(corrmat, 2)

melted_corrmat_rounded <- tibble(Var1 = rep(row.names(corrmat_rounded), length(colnames(corrmat_rounded))),
                                 Var2 = rep(colnames(corrmat_rounded), each = length(rownames(corrmat_rounded))),
