...
### Feces treatment day 2 (INDIVIDUAL)
...
### Feces treatment day 4 (INDIVIDUAL)
...
### Feces day 0 CTRL&PFOS (INDIVIDUAL)
...
### Feces day 0 VAN&VAN+PFOS (INDIVIDUAL)
...
### Feces day 2 CTRL&PFOS (INDIVIDUAL)
...
### Feces day 2 VAN&VAN+PFOS (INDIVIDUAL)
...
filename2 <- paste0("plots/adiv/alpha_f2/adiv_",SUBSET.VAR,"_",DAY.VAR,"_VAN_",VAN.VAR,"_",TEST.VAR,".pdf")
adiv_plot <- ggarrange(p.obs, p.eve, p.sdi, p.fpd, nrow = 1, labels = c("A)","B)","C)","D)"), common.legend = TRUE,legend = "bottom")
adiv.plotT <- adiv_plot + ggtitle(paste0("Difference in alpha diversity between ",TEST.VAR,":"))
suppressMessages(ggsave(filename = filename, plot = adiv.plotT, device = "png", units = "mm", width = 250, height = 100, dpi = 300))
suppressMessages(ggsave(filename = filename2, plot = adiv.plotT, device = "pdf", units = "mm", width = 250, height = 100, dpi = 300))
...
### Feces day 4 CTRL&PFOS (INDIVIDUAL)
...
### Feces day 4 VAN&VAN+PFOS (INDIVIDUAL)
...
# Create plot
p <- ggboxplot(adat, x = TEST.VAR, y = "Observed", label = "Sample",
          fill = TEST.VAR,
          add =  "jitter") +scale_fill_manual(values = COL)
...
### Feces day 8 CTRL&PFOS (INDIVIDUAL)
...
### Feces day 8 VAN&VAN+PFOS (INDIVIDUAL)
