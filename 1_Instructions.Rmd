...
This repository contains the code and data necessary to reproduce the complete statistical analysis for the article **"Fibre rich diet increases excretion of perfluorooctane sulfonic acid (PFOS) in male Sprague-Dawley rats"** (doi: ###########). All files and folders should be copied to your local folder to ensure script compliance.
