...
- **Animal identifiers**:
  ...
  + "rat_name" is corrected rat names due to non-continuous dissection days for rats *R41-R42* (day 21) and *R43-R44* (day 8). This column should be used for rat identification - same is corrected in metadata for microbiome data.
  + "cage" number (*01-24*)
...
- **PFOS quantitative data** in ug / g ("_ugg") or ug / mL ("_ugml), mg total ("_mg") and percentage of total dosed PFOS in systemic samples ("_pct"):
  ...
  + Systemic samples:
    ...
    + Brain values for day *8* and *21* (except *R01*, *R02*, *R13*)
...
# Transform data to dataframe with body weight "bw" and day of measurement "day" as column names

# Create data frame for data representation
dat.clean <- dat %>% select(rat_name, treatment, dissection, bw_0, bw_1, bw_2, bw_3, bw_4, bw_5, bw_6, bw_7, bw_8, bw_12, bw_16, bw_21) %>%
