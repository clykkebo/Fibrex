---
title: "7. Animal data (weight, transit time, PFOS, pH, SCFA)"
...
p <- ggboxplot(dat.clean, x = "day", y = "conc",
  ...
  annotate("text", x = 3, y = 65, label = paste("High fibre: ",round(reg_lines$slope[1],2)," µg/mL/day")) +
  annotate("text", x = 3, y = 62, label = paste("Low fibre: ",round(reg_lines$slope[2],2)," µg/mL/day"))
...
p.stat <- p + 
  ...
  annotate("text", x = 2, y = 5.1, size = 3, label = paste0("High fibre: ",round(reg_lines$slope[1],2)," µg/g/day")) +
  annotate("text", x = 2, y = 4.3, size = 3, label = paste0("Low fibre: ",round(reg_lines$slope[2],2)," µg/g/day"))
# View the final plot
p.stat
...
p.stat <- p + 
  ...
  annotate("text", x = 2, y = 210, size = 3, label = paste0("High fibre: ",round(reg_lines$slope[1],2)," µg/g/day")) +
  annotate("text", x = 2, y = 190, size = 3, label = paste0("Low fibre: ",round(reg_lines$slope[2],2)," µg/g/day"))
# View the final plot
p.stat
...
# SHORT-CHAIN FATTY ACIDS {.tabset .tabset-fade .tabset-pills}
...
## TOTAL SYSTEMIC PFOS ACCUMULATION (NOT USED)
This script makes a visualisation of accumulative systemic PFOS on Day 8 and 21.
