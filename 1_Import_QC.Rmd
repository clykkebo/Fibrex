...
# Rarefaction curves
Rcurve_data <- function(physeq, ntables=10, step=250,maxdepth = max(sample_sums(physeq)), methods=c("Observed","Chao1","ACE","Shannon","Evennes","Simpson"), seedstart=500, verbose=FALSE) {
  require("vegan")
...
# Calculate alpha diversity
Calculate_alpha_div <- function(physeq, ntables=100, depth = round(min(sample_sums(physeq))*0.9), methods=c("Observed","Chao1","ACE","Shannon","Evennes","Simpson"), seedstart=500, verbose=FALSE) {
  require("vegan")
...
meta$ID <- with(meta, paste(run,sampleID, sep = "_"))
...
R.methods <- c("Observed","Chao1","ACE","Shannon","Evennes","Simpson")
