...
This repository covers processing and analyses of data collected Fibrex project 
...
-   sequencing information (gram of material used for extracted DNA, DNA
    ...
    ("run" = c2, c3, c4))
-   treatment groups and several columns created for easy sample
    grouping during analysis, including for distinguishing between
    vancomycin and PFOS treatment alone.
